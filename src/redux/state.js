...
//To see value in the browser console
//window.stateEl = state;
...
export const addMessage = () => {
  ...
  let newMessage = {
    id: newId,
    text: state.dialogsPage.messagesData.newMessageText
  };

  state.dialogsPage.messagesData.myMessagesData.push(newMessage);
